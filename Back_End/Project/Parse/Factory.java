...
public class Factory {
    private static Project.parseEvaluator.Factory instance;
    private Factory(){}

    public static Project.parseEvaluator.Factory instance(){
        if (instance == null) {
            instance = new Project.parseEvaluator.Factory();
        }
        return instance;
    }
